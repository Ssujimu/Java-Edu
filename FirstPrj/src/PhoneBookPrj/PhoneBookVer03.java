...
class PhoneBookManager {
	...
	public void inputData() {
		...
		String name = MenuViewer3.keyboard.nextLine();
		System.out.println("전화번호 : ");
		String phone = MenuViewer3.keyboard.nextLine();
		System.out.println("생년월일 : ");
		String birth = MenuViewer3.keyboard.nextLine();
...
public class PhoneBookVer03 {
	...
	public static void main(String[] args) {
		...
		while(true) {
			MenuViewer3.showMenu();
			choice = MenuViewer3.keyboard.nextInt();
			MenuViewer3.keyboard.nextLine();
